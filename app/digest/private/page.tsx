...
export default function PrivateBottlesPage() {
    ...
    return (
        <div className="w-full pb-20 space-y-8">
            ...
            <Link
                href="/digest"
                className="inline-flex items-center gap-2 text-[#7C3AED] hover:text-[#6D28D9] transition-colors px-4 py-2 rounded-full text-sm font-medium w-max enter"
            >
                <ArrowLeft size={16} />
                Back to Drift
            </Link>
                ...
                <div className="relative z-10 flex flex-col md:flex-row md:items-center md:justify-between gap-6">
                    <div className="space-y-3 max-w-2xl">
                        ...
                        <p className="text-stone-600 text-lg leading-relaxed">
                            A collection of bottles that drifted your way specifically! Reply to brighten someone's day.
                        </p>
                    </div>
            ...
            <div className="bg-white p-8 rounded-[2rem] border border-violet-100 shadow-sm space-y-6 enter enter-d2">
            ...
            {/* List Header */}
            <div className="space-y-1 pt-4 enter enter-d3">
            ...
            {/* Bottle List */}
            <div className="space-y-5 enter enter-d4">
                {bottles.length === 0 ? (
            ...
            {/* Bottom CTA */}
            <div className="bg-gradient-to-r from-violet-600 to-indigo-600 p-8 rounded-[2rem] text-white shadow-lg space-y-5 enter enter-d5">
